...
exports.poolByID = function(req, res, next, name) {
	Pool.findOne({name: name}, {password: 0, admin: 0, _id: 0, createdOn: 0}).populate('members', 'displayName predictions points finalPoints winnerPoints totalPoints username -_id').exec(function(err, pool) {
